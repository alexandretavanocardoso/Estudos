...
namespace APICatalogo
{
    public class Startup
    {
        ...
        {
            var mapping5 = new MapperConfiguration(mc =>
            {
                mc.AddProfile(new MappingProfile());
            });

            // .NET 6
            // var mapping6 = new MapperConfiguration(mc =>
            // {
            //     mc.AddProfile(new MappingProfile());
            // });
            // 
            // IMapper mapper = mapping6.CreateMapper();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            // Define a ativação do logger que irá baixar um aruivo de log
